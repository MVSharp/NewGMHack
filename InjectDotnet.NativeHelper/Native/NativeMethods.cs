...
namespace InjectDotnet.NativeHelper.Native
{
    public static class NativeMethods
    {
        ...
        [DllImport(KERNEL32, SetLastError = true)]
        public static unsafe extern bool VirtualProtect(nint handle, nint size, MemoryProtection newProtect,
                                                        MemoryProtection* oldProtect);

        [DllImport(KERNEL32, SetLastError = true)]
        public static extern nint VirtualAlloc(nint             lpAddress, nint dwSize, AllocationType flAllocationType,
        ...
        [DllImport(KERNEL32, SetLastError = true)]
        public static extern nint AddVectoredExceptionHandler([MarshalAs(UnmanagedType.Bool)] bool first,
                                                              ExceptionHandlerDelegate             Handler);
