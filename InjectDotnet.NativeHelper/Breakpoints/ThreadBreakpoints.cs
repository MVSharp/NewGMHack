...
namespace InjectDotnet.NativeHelper.Breakpoints
{
    ...
    public class ThreadBreakpoints : IEnumerable<Breakpoint>
    {
        ...
        private static readonly Dictionary<int, ThreadBreakpoints> s_BpDict = new Dictionary<int, ThreadBreakpoints>();
        ...
        public Breakpoint this[DebugRegister register]
        {
            get
            {
                switch (register)
                {
                    case DebugRegister.Dr0: return _hwBreakpoints[0];
                    case DebugRegister.Dr1: return _hwBreakpoints[1];
                    case DebugRegister.Dr2: return _hwBreakpoints[2];
                    case DebugRegister.Dr3: return _hwBreakpoints[3];
        ...
        public static
            ...
            ThreadBreakpoints
#endif
            GetThreadBreakpoints(int threadId)
        {
        ...
        public bool SetDebugRegisters()
        {
            lock (this)
            {
                ...
                var hThread = CreateThread(IntPtr.Zero, 0, UpdateBreakpointsInternal, this, 0, out var threadId);
