    ...
    public class ImportHook : INativeHook
    {
        ...
        unsafe public bool InstallHook()
        {
            ...
            lock (this)
            {
                ...
                foreach (nint* pImportTableEntry in IATEntries)
                {
                    ...
                    NativeMethods.VirtualProtect((nint)pImportTableEntry, (nint)sizeof(nint),
                                                 MemoryProtection.ReadWrite, &oldProtect);
        ...
        unsafe public bool RemoveHook()
        {
            ...
            lock (this)
            {
                ...
                {
                    MemoryProtection oldProtect;
                    NativeMethods.VirtualProtect((nint)pImportTableEntry, (nint)sizeof(ulong),
