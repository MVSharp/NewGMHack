...
internal class CoreLoader : IManagedLoader
{
    ...
    public static CoreLoader Create(Process target,                    string runtimeConfig, string dllToInject,
                                    string  assemblyQualifiedTypeName, string method, ReadOnlySpan<byte> argument,
                                    bool    entryPoint)
    {
    ...
    private static unsafe string? GetHostfxrPath(Version? version)
    {
        ...
        var pf86 = Environment.GetEnvironmentVariable("ProgramW6432");
        var nethostPath =
            $@"{pf86}\dotnet\packs\Microsoft.NETCore.App.Host.win-{PLATFORM}\{version:3}\runtimes\win-{PLATFORM}\native\nethost.dll";
    ...
    {
        [FieldOffset(0)]    readonly nint fnConfig;
        [FieldOffset(8)]    readonly nint fnGetDelegate;
        [FieldOffset(0x10)] readonly nint fnClose;
        [FieldOffset(0x18)] readonly nint fnVirtualFree;
        [FieldOffset(0x20)] readonly nint fnLoadLibrary;
        [FieldOffset(0x28)] readonly nint fnGetProcAddress;
        [FieldOffset(0x30)] public   nint fnEntryPoint;
        [FieldOffset(0x38)] readonly nint _context;
        [FieldOffset(0x40)] readonly nint _delegate;
        [FieldOffset(0x48)] readonly nint _method_fn;

        [FieldOffset(0x50)] public   nint str_runtimeconfig;
        ...
        [FieldOffset(0x70)] public   nint str_hostfxr_path;
        [FieldOffset(0x78)] public   nint str_Config_name;
        [FieldOffset(0x80)] public   nint str_GetDelegate_name;
        [FieldOffset(0x88)] public   nint str_Close_name;
        [FieldOffset(0x90)] public   nint args;
        [FieldOffset(0x98)] public   int  sz_args;
        [FieldOffset(0xa0)] readonly nint fnExitThread;
