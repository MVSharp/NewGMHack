...
public static class DebuggerExtensions
{
    ...
    public static nint AllocateMemory(this Debugger    debugger, nint size,
                                      MemoryProtection memoryProtection = MemoryProtection.ExecuteReadWrite)
    {
        return NativeMethods.VirtualAllocEx(debugger.ProcessInfo.ProcessHandle, 0, size, AllocationType.ReserveCommit,
                                            memoryProtection);
    }

    public static unsafe nint WriteMemory(this Debugger    debugger, ReadOnlySpan<byte> buffer,
