...
internal class FrameworkLoader : IManagedLoader
{
    ...
    public static FrameworkLoader Create(Process target,         string dllToInject, string typeName, string methodName,
                                         string  methodArgument, bool   entryPoint)
    {
        ...
        if (target.MainModule?.FileName is string targetExe && target.GetModulesByName(MSCOREE_DLL).Any())
        {
            ...
            if (entryPoint)
                throw new ArgumentException("Cannot inject into a .NET Framework target at startup.",
                                            nameof(entryPoint));
            ...
            if (injectedVersion > targetVersion)
                throw new
                    Exception($"Injected Dll's framework version {injectorRuntime} is greater than the target's version {targetRuntime}");
    ...
    {
        //Kernel32 Procs
        [FieldOffset(0x0)]  readonly nint fnVirtualFree;
        [FieldOffset(0x8)]  readonly nint fnLoadLibrary;
        [FieldOffset(0x10)] readonly nint fnGetProcAddress;
        [FieldOffset(0x18)] public   nint fnEntryPoint;
        [FieldOffset(0x20)] readonly nint fnExitThread;

        //CLR Instances
        [FieldOffset(0x28)] readonly nint pMetaHost;
        [FieldOffset(0x30)] readonly nint pRuntimeInfo;
        [FieldOffset(0x38)] readonly nint pClrRuntimeHost;

        //CLR Parameters
        [FieldOffset(0x40)] public   nint str_mscoree_path;
        [FieldOffset(0x48)] public   nint str_CLRCreateInstance_name;
        [FieldOffset(0x50)] public   nint str_runtime_version;
        [FieldOffset(0x58)] public   nint str_dll_path;
        [FieldOffset(0x60)] public   nint str_type;
        [FieldOffset(0x68)] public   nint str_method_name;
        [FieldOffset(0x70)] public   nint str_argument;
        [FieldOffset(0x78)] readonly uint dw_return_value;

        [FieldOffset(0xb0)] readonly Guid _CLSID_CLRMetaHost;
        [FieldOffset(0xc0)] readonly Guid _IID_ICLRMetaHost;
        [FieldOffset(0xD0)] readonly Guid _IID_ICLRRuntimeInfo;
        [FieldOffset(0xE0)] readonly Guid _CLSID_CLRRuntimeHost;
        [FieldOffset(0xF0)] readonly Guid _IID_ICLRRuntimeHost;

        private static readonly Guid CLSID_CLRMetaHost =
            new(0x9280188d, 0x0e8e, 0x4867, 0xb3, 0x0c, 0x7f, 0xa8, 0x38, 0x84, 0xe8, 0xde);

        private static readonly Guid IID_ICLRMetaHost =
            new(0xd332db9e, 0xb9b3, 0x4125, 0x82, 0x07, 0xa1, 0x48, 0x84, 0xf5, 0x32, 0x16);

        private static readonly Guid IID_ICLRRuntimeInfo =
