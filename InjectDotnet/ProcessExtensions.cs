...
public static class ProcessExtensions
{
    ...
    public static unsafe nint WriteMemory(this Process     hProcess, ReadOnlySpan<byte> buffer,
                                          MemoryProtection protection = MemoryProtection.ReadWrite)
    {
        IntPtr baseAddress = NativeMethods.VirtualAllocEx(hProcess.Handle, IntPtr.Zero, buffer.Length,
                                                          AllocationType.ReserveCommit, protection);
    ...
    {
        IntPtr hThread =
            NativeMethods.CreateRemoteThread(proc.SafeHandle, IntPtr.Zero, 0, function, argument, 0, out _);
